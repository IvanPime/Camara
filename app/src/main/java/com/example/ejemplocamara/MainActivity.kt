...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Log.d(Constans.TAG,"No se pudo inicializar la cámara")
            }
    ...
    private fun takePhoto() {
        ...
        val photoFile = File(outPutDirectory, SimpleDateFormat(Constans.FILE_NAME_FORMAT, Locale.getDefault()).format(System.currentTimeMillis())+".jpg")
